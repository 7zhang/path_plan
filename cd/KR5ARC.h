...
#include "../extern/robotkinematic.h"
...
class API_DLL KR5ARC_RKA : public IKinematicAlg             //KR5ARC机器人算法类
{
	std::vector<DHparameters> DH;
public:
	KR5ARC_RKA()  ;
	virtual ~KR5ARC_RKA()  {}
	virtual RBTRESULT InverseRobot(JAngle& Jointangle,const JAngle& lastJointangle,const TRANS& t6);
	virtual RBTRESULT InverseRobotEx(vector<JAngle>& vecJointangle, const TRANS& t6);
	virtual RBTRESULT PositiveRobot(const JAngle& JA,TRANS& t6);
