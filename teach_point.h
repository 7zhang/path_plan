...
public:
	teach_point(std::vector<double>& mu_axis, std::vector<double>& sigma_axis,
		    std::vector<double>& offset_axis, std::vector<double>& weight_axis,
		    std::vector<double>& mu_aux, std::vector<double>& sigma_aux,
		    std::vector<double>& offset_aux, std::vector<double>& weight_aux)
		: m_mu_axis(mu_axis), m_sigma_axis(sigma_axis), 
